...
<div style="font-size:11px; font-family:Arial, Helvetica, sans-serif;text-align:center"><a href="http://express.ikoula.com/hebergement-web" title="Choisissez Ikoula pour tous vos projets d’hébergement web"><img alt="Choisissez Ikoula pour tous vos projets d’hébergement web" src="http://www.ikoula.com/img/heberge_par_ik_black.gif"  border="0"/></a><br><a href="http://express.ikoula.com/cloud" title="Choisissez Ikoula pour tous vos projets d’hébergement web" target="_blank">Serveur Cloud</a>  |  <a href="http://express.ikoula.com/hebergement-web" title="Choisissez Ikoula pour tous vos projets d’hébergement web" target="_blank">Hébergement web</a></div>
                            </div>
							<div class="span4">
