...
{ ?>
    <li class="bordered-grey"><a href="/"><i class="icon-home"></i>&nbsp;Home</a></li>
    <li class="bordered-grey"><a href="/faq"><i class="icon-th-list"></i>&nbsp;Get started</a></li>
    <li class="bordered-grey"><a href="/about"><i class="icon-comment"></i>&nbsp;Who are we?</a></li>
    <li class="bordered-grey"><a href="/contact"><i class="icon-envelope"></i>&nbsp;Contact</a></li>
    <li><a href="/terms"><i class="icon-bullhorn"></i>&nbsp;About</a></li>
						</ul>
					</div><!--/.nav-collapse -->
				</div><!--/.container-->
			</div><!--/.navbar-inner -->
    <div class="sub-navbar">
        <div class="container">
            <p><i class="icon icon-user"></i> You already have an account? <a class="btn btn-login" href="/login">Log in »</a></p>
        </div>
    </div>
...
else
{
    ...
    ?>
    <!-- Rubriques de "base" -->
    <li class="bordered-grey"><a href="/"><i class="icon-home icon-white"></i>&nbsp;Home</a></li>
    <li class="bordered-grey"><a href="/files/"><i class="icon-folder-open icon-white"></i>&nbsp;Documents</a></li>
    <li class="bordered-grey"><a href="/friends"><i class="icon-user icon-white"></i>&nbsp;Friends</a></li>
    ...
    <li class="dropdown bordered-grey" id="dropnotif" data-dropdown="dropdown">
        ...
        <ul id="dropdown-notif" class="dropdown-menu">
            <li><a href="#" id="no_notif">You have no notifications</a></li>
        </ul>
    </li> <!-- //notifs-dropdown -->
    ...
    <li class="dropdown bordered-grey" id="dropmemo" data-dropdown="dropdown">
        ...
        <ul id="dropdown-memo" class="dropdown-menu">
            ...
            <button id="savebutton" onclick="saveMemo()" class="btn">Save</button>
        </ul>
    </li> <!-- //memo-dropdown -->

    <!-- music dropdown -->
    <li class="dropdown" id="dropmusic" data-dropdown="dropdown">
        <a class="dropdown-toggle" href="#"><i class="icon-music"></i> Music player</a>
        ...
        <p>
            ...
            <span class="bordered">
						...
						<span class="bordered menu">
							<i class="icon-hdd"></i> Free space : <?php echo round(\lib\Converter::size($user->config()->get('free_space'), "Go"), 3); ?> Go
						</span>
            <span class="menu"><a class="btn btn-login" href="/logout">Logout »</a></span>
        </p>
    </div>
</div>
    <?php
...
<footer>
    <div class="container">
        <div class="span12">
            <div class="row">
                <div class="span2">
                    <h5><i class="icon-th-list"></i> Sitemap</h5>
                    <div class="frub">
                        <div>
                            <p>
                                <a href="/about">Who are we?</a><br />
                                <a href="/contact">Contact</a><br />
                                <a href="/terms#disponibilite" >Imprint</a><br />
                ...
                <div class="span3">
                    <h5><i class="icon-comments"></i> Social networks</h5>
                    <p>Discuss with us, share your opinions, follow and support the development of the project on <a href="http://twitter.com/shareanet"><i class="icon-twitter"></i> Twitter</a> and <a href="http://facebook.com/shareanet"> <i class="icon-facebook"></i> Facebook</a></p>
                ...
                <div class="span4">
                    ...
                    <p>Subscribe to the newsletter to be kept abreast of developments on the platform!</p>
                    <form method="POST" action="/newsletter">
                        <input id="newsmail" type="email" name="newsmail" placeholder="E-mail address"/><button type="submit" class="btn btn-primary">Go</button>
                    </form>
                </div>
            </div>
        </div>
