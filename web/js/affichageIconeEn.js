...
function displayFoldersIcon(data) {
    ...
    retour.innerHTML = '<img src="/images/folder_home.png" alt="home"><br><span class="grey">Back</span>';
    ...
    if (data.folders != null) {
        for (var i = 0; i < data.folders.length; i++) {
            ...
            div.setAttribute("data-original-title", "Folder properties")
            div.setAttribute("id", "dossier"+i);
            div.setAttribute("rel", "popover");
            div.setAttribute("data-content", "Name: <b>"+data.folders[i].name+"</b><br>Permission: <b>"+permission+"</b><br />Created the: <b>"+data.folders[i].date+"</b>");
            ...
            divBtn.innerHTML = '<li class="dropdown" data-dropdown="dropdown">' +
                ...
                '<li><a href="#" onclick="renommerdossier(\'' + data.folders[i].id + '\', \'' + data.folders[i].name + '\')" data-controls-modal="renommerdossier" data-backdrop="static"><i class="icon-pencil"></i> Rename</a></li>' +
                '<li><a href="#" onclick="partagerdossier(\'' + data.folders[i].id + '\', \'' + data.folders[i].name + '\', \'' + data.folders[i].permission + '\')" data-controls-modal="partagerdossier" data-backdrop="static"><i class="icon-share"></i> Share</a></li>' +
                '<li class="divider"></li><li><a href="#" onclick="supprimerdossier(\'' + data.folders[i].id + '\', \'' + data.folders[i].name + '\')" data-controls-modal="supprimerdossier" data-backdrop="static"><i class="icon-remove"></i> Remove</a></li>' +
                '</ul></li>';
...
function displayFilesIcon(data) {
    ...
    if (data.files != null) {
        for (var i = 0; i < data.files.length; i++) {
            ...
            var div = document.createElement("div");
            div.setAttribute("class", "fd");
            div.setAttribute("data-original-title", "File properties")
            ...
            div.setAttribute("data-content", "Name: <b>"+data.files[i].name+"</b><br>Permission: <b>"+permission+"</b><br />Uploaded the: <b>"+data.files[i].date+"</b>");
            ...
            divBtn.innerHTML = '<li class="dropdown" data-dropdown="dropdown">' +
                ...
                '<li class="divider"></li>' +
                '<li><a href="#" onclick="supprimer(\'' + data.files[i].id + '\', \'' + data.files[i].name + '\')" data-controls-modal="supprimerfichier" data-backdrop="static"><i class="icon-remove"></i> Remove</a></li>'
            '</ul></li>';
